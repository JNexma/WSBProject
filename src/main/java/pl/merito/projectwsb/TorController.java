...
public class TorController implements Initializable {
        ...
        if (!checkFields()) {
            ...
            if (pathForSave == null) {
                ...
                ThreadForGenerating generate = new ThreadForGenerating(fullName_get, dateOfBirth_get, passport_get,
                        ...
                        pathForSave, genInterviewText, accommodation_get, admPay_get, admDate_get, currentMonth);
                generate.start();
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        List<ChoiceBox> choiceBoxes = new ArrayList<>(Arrays.asList(degree_input, intake_input, language_input, paymentCurrency_input, typeOfStudy_input,installments_input, accommodation_input));
        List <String[]> choiceBoxesList = new ArrayList<>(Arrays.asList(degree_list, intake_list, language_list, paymentCurrency_list, typeOfStudy_list, installments_list, accommodation_list));
    ...
    //Check if tuition and administrative fees are int
